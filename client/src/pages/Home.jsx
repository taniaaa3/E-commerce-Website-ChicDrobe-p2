...
import { faTruck, faCalendar, faIdBadge } from '@fortawesome/free-solid-svg-icons'
...
const Home = () => {
  ...
  <div class="mx-auto mt-10 w-full max-w-screen-xl px-4">
  <div class="w-12 border-b-2 border-pink-500 lg:border-b-4"></div>
  <h2 class="mt-6 mb-10 text-3xl font-semibold tracking-wide text-gray-800 sm:text-6xl">Why ChicDrobe?</h2> 
  <div class="flex flex-col justify-between lg:flex-row lg:flex-wrap">
    <div class="mt-8 lg:mt-10 lg:w-1/2">
      <div class="flex flex-col items-start lg:pr-16">
        <div class="w-16">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
            ...
            <g>
              <path fill="#d500f9" class="primary-color" d="M475.6,460.2H461v-53.8h14.6V460.2z"></path>
              <path fill="#ffea00" class="secondary-color" d="M475.6,229.8H461V176h14.6V229.8z M475.6,252.8H461v53.8h14.6V252.8z M475.6,329.6H461v53.8h14.6V329.6z             M36,35v60.9L96.9,35H36z"></path>
            </g>
        ...
        <h2 class="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl">
          <span class="mr-5 text-2xl">Trendsetting Fashion</span>
        </h2>
        <p class="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Discover the latest trends and styles that redefine your wardrobe. ChicDrobe brings you fashion-forward collections curated for those who love staying ahead in style.</p>
      </div>
    </div>
    <div class="mt-8 lg:mt-10 lg:w-1/2">
      <div class="flex flex-col items-start lg:pr-16">
        ...
        <h2 class="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl">
          <span class="mr-5 text-2xl">Quality Craftsmanship</span>
        </h2>
        <p class="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">At ChicDrobe, we prioritize quality in every stitch. Experience premium craftsmanship with our carefully selected materials and attention to detail, ensuring long-lasting and stylish pieces.</p>
      </div>
    </div>
    <div class="mt-8 lg:mt-10 lg:w-1/2">
      <div class="flex flex-col items-start lg:pr-16">
        <div class="w-16">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
            ...
            <path fill="#ffea00" class="secondary-color" d="M490.4,379.2v44.5H446v-44.5H490.4z M446,490.6h44.5v-44.5H446V490.6z M377.6,490.6h44.5v-44.5h-44.5V490.6z        "></path>
        ...
        <h2 class="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl"><span class="mr-5 text-2xl">Customer-Centric Experience</span></h2>
        <p class="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Enjoy a seamless shopping journey with ChicDrobe's customer-centric approach. From intuitive browsing to swift delivery, we prioritize your satisfaction at every step.</p>
      </div>
    </div>
    <div class="mt-8 lg:mt-10 lg:w-1/2">
      <div class="flex flex-col items-start lg:pr-16">
        ...
        <h2 class="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl"><span class="mr-5 text-2xl">Exclusive Collections</span></h2>
        <p class="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Elevate your style with ChicDrobe's exclusive collections, thoughtfully designed to cater to diverse tastes. Stand out from the crowd with unique pieces you won't find elsewhere.</p>
      </div>
    </div>
  </div>
</div>
...
<div className="mx-auto py-8 w-full max-w-7xl rounded-lg m-2 bg-white sm:border sm:border-purple-400">
      <div className="flex flex-wrap justify-center items-center">
        {guarantees.map(service => {
          return (
            <div key={service.id} className="flex-shrink-0 group m-5 px-3 inline-flex items-center space-x-2 cursor-default">
              <FontAwesomeIcon icon={service.icon} className="w-7 h-7 text-purple-900" />
              <span className="text-base text-black font-bold group-hover:text-indigo-500">{service.details}</span>
            </div>
          )
        })
        }
