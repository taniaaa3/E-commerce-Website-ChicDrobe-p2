...
const Contact = () => {
  ...
  const sendMessage = (e)=>{
      ...
      axios.post('http://localhost:3003/connect/contact',contact).then((res)=>{
    ...
    <div className="contact flex flex-col sm:flex-row justify-evenly items-center">
        ...
        <div className="sm:w-1/2 w-full">
            <form className="form flex flex-col px-2 py-2 m-5 rounded-lg" onSubmit={sendMessage}>
                <label htmlFor="name" className="pl-2 font-medium">Name:</label>
                ...
                <label htmlFor="mail" className="pl-2 font-medium">Email:</label>
                ...
                <label htmlFor="msg" className="pl-2 font-medium">Message:</label>
